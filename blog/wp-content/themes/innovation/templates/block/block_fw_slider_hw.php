...
/**
 * Class innovation_ruby_fw_slider_hw
 * render has wrapper slider
 */
if ( ! class_exists( 'innovation_ruby_fw_slider_hw' ) ) {
	class innovation_ruby_fw_slider_hw extends innovation_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes']                  = 'block-fw-slider-hw';
