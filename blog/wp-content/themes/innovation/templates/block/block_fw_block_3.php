...
/**
 * Class innovation_ruby_fw_block_3
 * render has fullwidth block 3 (overlay grid layout)
 */
if ( ! class_exists( 'innovation_ruby_fw_block_3' ) ) {
	class innovation_ruby_fw_block_3 extends innovation_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'block-fw-post-3';
		...
		static function render_content( $block ) {
			...
			if ( empty( $query_data->post_count ) ) {
				...
				<?php while ( $query_data->have_posts() ) : ?>
					...
					//render block
					echo '<div class="post-grid-outer is-light-text col-sm-4 col-xs-12">';
