...
/**
 * Class innovation_ruby_fw_block_2
 * render has fullwidth block 2 (small grid layout)
 */
if ( ! class_exists( 'innovation_ruby_fw_block_2' ) ) {
	class innovation_ruby_fw_block_2 extends innovation_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'block-fw-post-2';
