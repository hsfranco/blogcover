...
/**
 * Class innovation_ruby_fw_carousel_small
 * render full width small carousel
 */
if ( ! class_exists( 'innovation_ruby_fw_carousel_small' ) ) {
	class innovation_ruby_fw_carousel_small extends innovation_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes']                  = 'block-fw-carousel-small';
		...
		static function render_content( $block ) {
			...
			if ( empty( $query_data->post_count ) ) {
				...
				<div class="feat-wrap is-feat-carousel-fw-small">
					<div class="feat-inner">
						<div class="slider-loading"></div>
						<div class="ruby-feat-carousel-fw-small is-light-text slider-init">
							<?php while ( $query_data->have_posts() ) : ?>
								<?php $query_data->the_post(); ?>
								<?php get_template_part( 'templates/featured/loop', 'feat_carousel_fw_small' ); ?>
							<?php endwhile; ?>
						</div>
					</div>
				</div><!--#small fw carousel-->
