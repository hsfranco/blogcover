...
/**
 * Class innovation_ruby_hs_block_4
 * render has sidebar block 4 (grid layout)
 */
if ( ! class_exists( 'innovation_ruby_hs_block_4' ) ) {
	class innovation_ruby_hs_block_4 extends innovation_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'block-post-4';
