...
/**
 * Class innovation_ruby_fw_block_code
 * render has fullwidth block code
 */
if ( ! class_exists( 'innovation_ruby_fw_block_code' ) ) {
	class innovation_ruby_fw_block_code extends innovation_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'block-fw-code';
