...
innovation_ruby_template_part::open_page_wrap( 'single-post-outer single-layout-feat-fw', $ruby_sidebar_position, true );
...
innovation_ruby_single_layout::open_single_header( 'is-cell is-align-bottom is-light-text' );
