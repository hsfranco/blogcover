<?php $ruby_featured_attachment = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'innovation_ruby_840x500' ); ?>
<article class="post-wrap post-feat-grid is-slider-post" style="background-image: url(<?php echo esc_url( $ruby_featured_attachment[0] ); ?>)">
