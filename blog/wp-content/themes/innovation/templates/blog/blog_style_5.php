 ...
 *
 * @return string
 * render small grid layout
 */
if ( ! class_exists( 'innovation_ruby_sgrid_layout' ) ) {
	class innovation_ruby_sgrid_layout {
		...
		static function render( $ruby_options ) {
			...
			//render
			innovation_ruby_template_part::open_page_inner( 'page-layout-inner', $ruby_options['sidebar_position'], 'sgrid-layout', $ruby_options['big_first'] );
